# Capture The Flag – Crypto & Steganography Lab
...
## Overview
- Part 1: Web inspection, image steganography, Caesar cipher
- Part 2: MD5 verification, XOR decryption
- Part 3: Audio steganography, archive cracking, Python cryptography
